...
public class B_2_Tokitsukaze_and_Good_01_String_hard_version {
    public static void s() {
        ...
        while(!q.isEmpty()) {
            ...
            if(f%2 == 0) {
                ...
                int fs = q.removeFirst();
                if(fs == 1) {
                    if(q.isEmpty()) q.add(f+fs);
                    else {
                        int fss = q.removeFirst();
                        q.addFirst(f+fs+fss);
                    }
                } else if(fs == 2) {
                    int fss = q.removeFirst();
