...
public class B_AccurateLee {
    public static void s() {
        ...
        for(int i=0; i<s.length(); i++) {
            ...
            if(one && s.charAt(i) == '0') zero = true;
        }
        for(int i=0; i<s.length() && (s.charAt(i) == '0'); i++) strb.append('0');
        if(one && zero) strb.append('0');
        for(int i=s.length()-1; i>=0 && s.charAt(i) == '1'; i--) strb.append('1');
