        ...
        for(int i=1; i<=q; i++) {
            ...
            if(qq == 1) {
                ...
                /*
                    ...
                    I'll give you query to either add [x, y] or remove [x, y]

                    and a query in which [x1, y1] && [x2, y2] will be given
                    
                 * for every x in [x1, x2] either x contains x is in the set
                 * or for that x [y1, y2] is in the set..
                 * 
                 * 
                 */
            }
