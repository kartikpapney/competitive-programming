...
public class D_Odd_Even_Subsequence {
    ...
    public static boolean canPlaceOdd(int[] arr, int val, int k) {
        int cnt = 0;
        for(int v : arr) {
            if(cnt%2 == 0) {
                if(v <= val) cnt++;
    ...
    public static boolean canPlaceEven(int[] arr, int val, int k) {
        int cnt = 0;
        for(int v : arr) {
            if(cnt%2 == 0) {
                cnt++;
    ...
    public static void s() {
        ...
        while(low <= high) {
            ...
            if(canPlaceEven(arr, mid, k) || canPlaceOdd(arr, mid, k)) {
                high = mid-1;
                ans = mid;
            } else {
                low = mid+1;
