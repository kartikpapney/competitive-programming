...
public class E1_Close_Tuples_easy_version_ {
    static long nCr(long n, long r) {
        ...
        for(long i=n-r; i>=2; i--) {
            ans/=i;
        }
        return ans;

    }
    static long fn(long a, long b, long c, long x, long y, long z) {
        return nCr(a,x)*nCr(b, y)*nCr(c, z);
    }
    public static void s() {
        ...
        for(Map.Entry<Long, Long> mp : map.entrySet()) {
            long val = mp.getKey();
            long a = map.getOrDefault(val, 0l);
            long b = map.getOrDefault(val + 1, 0l);
            long c = map.getOrDefault(val + 2, 0l);
            count += 
            fn(a, b, c, 1, 1, 1) + 
            fn(a, b, c, 1, 2, 0) + 
            fn(a, b, c, 1, 0, 2) + 
