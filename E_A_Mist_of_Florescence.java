...
public class E_A_Mist_of_Florescence {
    ...
    public static void s() {
        ...
        boolean full = true;
        for(int i=0; i<25; i++) {
            if(!full) for(int j=0; j<50; j+=2) arr[i][j] = 'D';
            else for(int j=0; j<50; j++) arr[i][j] = 'D';
            full = !full;
        }
        full = true;
        for(int i=25; i<50; i++) {
            if(!full) for(int j=0; j<50; j+=2) arr[i][j] = 'B';
            else for(int j=0; j<50; j++) arr[i][j] = 'B';
            full = !full;
        }  
        d--;
        b--;
